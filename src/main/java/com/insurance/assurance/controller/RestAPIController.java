...
import com.insurance.assurance.service.PolicyServices;
...
import com.insurance.assurance.model.Policy;
	...
	public ResponseEntity<Message> getPolicyById(@PathVariable long id) {
		try {
			...
			if(optPolicy.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a policy by id = " + id, Arrays.asList(optPolicy.get()), null, null, null, null, null, null, ""), HttpStatus.OK);
			} else {
