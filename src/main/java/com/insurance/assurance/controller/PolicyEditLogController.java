...
import com.insurance.assurance.service.PolicyEditLogServices;
...
public class PolicyEditLogController {
	...
	public ResponseEntity<Message> retrievePolicyEditLogInfo() {
		...
		try {
			...
			return new ResponseEntity<Message>(new Message("Get Policys Edit Log' Infos!", null, policyEditLogInfos, null, null, null, null, null, ""), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Message> getPolicyEditLogById(@PathVariable long id) {
		try {
			...
			if (optPolicy.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a policy by id = " + id, null, Arrays.asList(optPolicy.get()), null, null, null, null, null, ""), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(new Message("Failure -> NOT Found a policy by id = " + id, null, null, null, null, null, null, ""), HttpStatus.NOT_FOUND);
			}
		} catch (Exception e) {
		...
		try {
			if (policyEditLogServices.checkExistedPolicyEditLog(id)) {
				...
				return new ResponseEntity<Message>(
						new Message("Successfully! Updated a PolicyEditLog " + "with id = " + id, Arrays.asList(policyEditLog), null, null, null, null, null, ""), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(
