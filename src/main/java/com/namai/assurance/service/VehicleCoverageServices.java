...
public class VehicleCoverageServices {
	...
	@Autowired private VehicleServices vehicleServices;
	@Autowired private CoverageServices coverageServices;
	
	public VehicleServices getVehicleServices() { return vehicleServices; }
	public void setVehicleServices(VehicleServices vehicleServices) { this.vehicleServices = vehicleServices; }
