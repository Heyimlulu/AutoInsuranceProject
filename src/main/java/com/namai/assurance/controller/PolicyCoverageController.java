	...
	public ResponseEntity<Message> getPolicyCoverageId(@PathVariable long id) {
		try {
			...
			if (optPolicyCoverage.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a Policy coverage by id = " + id, null, null, null, null, null, null, null, Arrays.asList(optPolicyCoverage.get()), null, ""), HttpStatus.OK);
			} else {
		...
		try {
			if (policyCoverageServices.checkExistedPolicyCoverage(id)) {
				...
				return new ResponseEntity<Message>(
						new Message("Successfully! Updated a Policy coverage " + "with id = " + id, null, null, null, null, null, null, null, null, null, ""), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(
