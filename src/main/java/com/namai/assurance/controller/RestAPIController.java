...
public class RestAPIController {
	...
	public ResponseEntity<Message> addNewPolicy(@RequestBody Policy policy) {
		try {
			...
			return new ResponseEntity<Message>(new Message("Upload Successfully!", Arrays.asList(returnedPolicy), null, null, null, null, null, null, null, ""), HttpStatus.OK);
		}catch(Exception e) {
	...
	public ResponseEntity<Message> retrievePolicyInfo() {
		...
		try {
			...
			return new ResponseEntity<Message>(new Message("Get Policys' Infos!", policyInfos, null, null, null, null, null, null, null, ""), HttpStatus.OK);
		}catch(Exception e) {
	...
	public ResponseEntity<Message> updatePolicyById(@RequestBody Policy _policy, @PathVariable long id) {
		try {
			if(policyServices.checkExistedPolicy(id)) {
				...
				return new ResponseEntity<Message>(new Message("Successfully! Updated a Policy " + "with id = " + id, Arrays.asList(policy), null, null, null, null, null, null, null, ""), HttpStatus.OK);
			}else {
