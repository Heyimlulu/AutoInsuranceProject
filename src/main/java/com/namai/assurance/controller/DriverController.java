...
public class DriverController {
	...
	public ResponseEntity<Message> addNewPolicy(@RequestBody Driver driver, @PathVariable long id) {
		try {
			...
			return new ResponseEntity<Message>(new Message("Upload Successfully!",  null,null, null, null, null, Arrays.asList(returnedDriver), null, null, ""), HttpStatus.OK);
		} catch(Exception e) {
	...
	public ResponseEntity<Message> retrievePolicyInfo() {
		...
		try {
			...
			return new ResponseEntity<Message>(new Message("Get Driver Infos!", null, null, null, null, null, driverInfos, null, null, null), HttpStatus.OK);
		}catch(Exception e) {
	...
	public ResponseEntity<Message> getPolicyById(@PathVariable long id) {
		try {
			...
			if(optDriver.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a driver by id = " + id, null, null, null, null, null, Arrays.asList(optDriver.get()), null, null, ""), HttpStatus.OK);
			} else {
