...
public class DriverController {
	...
	public ResponseEntity<Message> addNewPolicy(@RequestBody Driver driver, @PathVariable long id) {
		try {
			...
			return new ResponseEntity<Message>(new Message("Upload Successfully!",  null,null, null, null, null, Arrays.asList(returnedDriver), null, null, null, ""), HttpStatus.OK);
		} catch(Exception e) {
			return new ResponseEntity<Message>(new Message("Fail to post a new Driver!", null, null, null, null, null, null, null, null, e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<Message> retrievePolicyInfo() {
		...
		try {
			...
			return new ResponseEntity<Message>(new Message("Get Driver Infos!", null, null, null, null, driverInfos, null, null, null, null), HttpStatus.OK);
		}catch(Exception e) {
	...
	public ResponseEntity<Message> getPolicyById(@PathVariable long id) {
		try {
			...
			if(optDriver.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a driver by id = " + id, null, null, null, null, Arrays.asList(optDriver.get()), null, null, null, ""), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(new Message("Failure -> NOT Found a driver by id = " + id, null, null, null, null, null, null, null, null, ""), HttpStatus.NOT_FOUND);
			}
		}catch(Exception e) {
	...
	public ResponseEntity<Message> updateDriverById(@RequestBody Driver _driver, @PathVariable long id) {
		try {
			if(driverServices.checkExistedDriver(id)) {
				...
				return new ResponseEntity<Message>(new Message("Successfully! Updated a Driver " + "with id = " + id, null, null, null, null, Arrays.asList(driver), null, null, null, ""), HttpStatus.OK);
			}else {
				return new ResponseEntity<Message>(new Message("Failer! Can NOT Found a Driver " + "with id = " + id, null, null, null, null, null, null, null, null, ""), HttpStatus.NOT_FOUND);
			}
		}catch(Exception e) {
			return new ResponseEntity<Message>(new Message("Failure", null, null, null, null, null, null, null, null, e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<Message> deleteDriverById(@PathVariable long id) {
		try {
			...
			if(driverServices.checkExistedDriver(id)) {
				...
				return new ResponseEntity<Message> (new Message("Successfully! Delete a Driver with id = " + id, null, null, null, null, null, null, null, null, ""), HttpStatus.OK);
			}else {
				return new ResponseEntity<Message>(new Message("Failer! Can NOT Found a Driver " + "with id = " + id, null, null, null, null, null, null, null, null, ""), HttpStatus.NOT_FOUND);
			}
		}catch(Exception e) {
