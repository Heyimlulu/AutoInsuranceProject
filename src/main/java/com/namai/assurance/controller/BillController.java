...
public class BillController {
	...
	public ResponseEntity<Message> addNewBill(@RequestBody Bill bill, @PathVariable long id) {
		try {
			...
			return new ResponseEntity<Message>(new Message("Upload Successfully!", null, null, Arrays.asList(returnedPolicy), null, ""), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Message> retrieveBillInfo() {
		...
		try {
			...
			return new ResponseEntity<Message>(new Message("Get Bill's Infos!",	null, null, billInfos, null, ""), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Message> getBillById(@PathVariable long id) {
		try {
			...
			if (optPolicy.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a Bill by id = " + id, null, null, Arrays.asList(optPolicy.get()), null, ""), HttpStatus.OK);
			} else {
