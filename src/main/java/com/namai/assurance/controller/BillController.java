...
public class BillController {
	...
	public ResponseEntity<Message> addNewBill(@RequestBody Bill bill, @PathVariable long id) {
		try {
			...
			return new ResponseEntity<Message>(new Message("Fail to post a new Bill!", null, null, null, null, null,null, null, e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<Message> retrieveBillInfo() {
		...
		try {
			...
			return new ResponseEntity<Message>(new Message("Get Bill's Infos!",	null, null, billInfos, null, null, null, null, null, null, null), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Message> getBillById(@PathVariable long id) {
		try {
			...
			if (optBill.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a Bill by id = " + id, null,  Arrays.asList(optBill.get()), null, null, null, null, null, null), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(new Message("Failure -> NOT Found a Bill by id = " + id, null, null, null, null, null, null, null, null), HttpStatus.NOT_FOUND);
			}
		} catch (Exception e) {
		...
		try {
			if (billServices.checkExistedBill(id)) {
				...
				return new ResponseEntity<Message>(
						new Message("Successfully! Updated a Bill " + "with id = " + id, null, Arrays.asList(bill), null, null, null, null, null, null), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(
						new Message("Failer! Can NOT Found a Bill " + "with id = " + id, null, null, null, null, null, null, null, null), HttpStatus.NOT_FOUND);
			}
		} catch (Exception e) {
			return new ResponseEntity<Message>(new Message("Failure", null, null, null, null, null, null, null, e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<Message> deleteBillById(@PathVariable long id) {
		try {
			...
			if (billServices.checkExistedBill(id)) {
				...
				return new ResponseEntity<Message>(
						new Message("Successfully! Delete a Bill with id = " + id, null, null, null, null, null, null, null, null), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(
						new Message("Failer! Can NOT Found a Bill " + "with id = " + id, null, null, null, null, null, null, null, null), HttpStatus.NOT_FOUND);
			}
