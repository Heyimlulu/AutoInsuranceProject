...
public class VehicleController {
	...
	public ResponseEntity<Message> addNewVehicle(@RequestBody Vehicle vehicle, @PathVariable long id) {
		try {
			...
			return new ResponseEntity<Message>(new Message("Upload Successfully!", null, null, null, null, Arrays.asList(returnedVehicle), null, null, null, ""), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Message> retrieveVehicleInfo() {
		...
		try {
			...
			return new ResponseEntity<Message>(new Message("Get Vehicle's Infos!", null, null, null, null, paymentDetailInfos, null, null, null, ""), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Message> getVehicleById(@PathVariable long id) {
		try {
			...
			if (optVehicle.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a Vehicle by id = " + id, null, null, null, null, Arrays.asList(optVehicle.get()), null, null, null, ""), HttpStatus.OK);
			} else {
