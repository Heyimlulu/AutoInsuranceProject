...
public class VehicleController {
	...
	public ResponseEntity<Message> addNewVehicle(@RequestBody Vehicle vehicle, @PathVariable long id) {
		try {
			...
			return new ResponseEntity<Message>(new Message("Fail to post a new Vehicle!", null, null, null, null, null, null, null, null, e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<Message> getVehicleById(@PathVariable long id) {
		try {
			...
			if (optVehicle.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a Vehicle by id = " + id, null, null, null, null, Arrays.asList(optVehicle.get()), null, null, null, null, ""), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(new Message("Failure -> NOT Found a Vehicle by id = " + id, null, null, null, null, null, null, null, null, ""), HttpStatus.NOT_FOUND);
			}
		} catch (Exception e) {
		...
		try {
			if (vehicleServices.checkExistedVehicle(id)) {
				...
				return new ResponseEntity<Message>(
						new Message("Successfully! Updated a Vehicle " + "with id = " + id, null, null, null, null, Arrays.asList(vehicle), null, null, null, null, ""), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(
						new Message("Failer! Can NOT Found a Vehicle " + "with id = " + id, null, null, null, null, null, null, null, null, ""), HttpStatus.NOT_FOUND);
			}
		} catch (Exception e) {
			return new ResponseEntity<Message>(new Message("Failure", null, null, null, null, null, null, null, null, e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<Message> deleteVehicleById(@PathVariable long id) {
		try {
			...
			if (vehicleServices.checkExistedVehicle(id)) {
				...
				return new ResponseEntity<Message>(
						new Message("Successfully! Delete a Vehicle with id = " + id, null, null, null, null, null, null, null, null, null, ""), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(
						new Message("Failer! Can NOT Found a Vehicle " + "with id = " + id, null, null, null, null, null, null, null, null, ""), HttpStatus.NOT_FOUND);
			}
