...
public class CoverageController {
	...
	public ResponseEntity<Message> addNewCoverage(@RequestBody Coverage coverage) {
		try {
			...
			return new ResponseEntity<Message>(new Message("Upload Successfully!", null, null, null, null, null, Arrays.asList(returnedCoverage), null, null, ""),
					HttpStatus.OK);
		} catch (Exception e) {
			return new ResponseEntity<Message>(new Message("Fail to post a new Coverage!", null, null, null, null, null, null, null, null, e.getMessage()),
	...
	public ResponseEntity<Message> retrieveCoverageInfo() {
		...
		try {
			...
			return new ResponseEntity<Message>(new Message("Get Coverage Infos!", null, null, null, null, null, coverageInfos, null, null, ""), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Message> getCoverageId(@PathVariable long id) {
		try {
			...
			if (optCoverage.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a coverage by id = " + id, null, null, null, null, null, Arrays.asList(optCoverage.get()), null, null, ""), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(new Message("Failure -> NOT Found a coverage by id = " + id, null, null, null, null, null, null, null, null, ""),
		...
		try {
			if (coverageServices.checkExistedCoverage(id)) {
				...
				return new ResponseEntity<Message>(
						new Message("Successfully! Updated a Coverage " + "with id = " + id, null, null, null, null, null, Arrays.asList(coverage), null, null, ""), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(
						new Message("Failer! Can NOT Found a Coverage " + "with id = " + id, null, null, null, null, null, null, null, null, ""),
						HttpStatus.NOT_FOUND);
			}
		} catch (Exception e) {
	...
	public ResponseEntity<Message> deleteCoverageById(@PathVariable long id) {
		try {
			...
			if (coverageServices.checkExistedCoverage(id)) {
				...
				return new ResponseEntity<Message>(
						new Message("Successfully! Delete a Coverage with id = " + id, null, null, null, null, null, null, null, null, ""), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(
						new Message("Failer! Can NOT Found a Coverage " + "with id = " + id, null, null, null, null, null, null, null, null, ""),
						HttpStatus.NOT_FOUND);
