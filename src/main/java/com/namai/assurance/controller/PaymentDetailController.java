...
public class PaymentDetailController {
	...
	public ResponseEntity<Message> retrievePaymentDetailInfo() {
		...
		try {
			...
			return new ResponseEntity<Message>(new Message("Get Payment Detail's Infos!", null, null, null, paymentDetailInfos, null, null, null, null), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Message> getPaymentDetailById(@PathVariable long id) {
		try {
			...
			if (optPaymentDetail.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a Payment Detail by id = " + id, null, null, null, Arrays.asList(optPaymentDetail.get()), null, null, null, null), HttpStatus.OK);
			} else {
		...
		try {
			if (paymentDetailServices.checkExistedPaymentDetail(id)) {
				...
				return new ResponseEntity<Message>(
						new Message("Successfully! Updated a Payment Detail " + "with id = " + id, null, null, null, Arrays.asList(paymentDetail), null, null, null, null), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(
