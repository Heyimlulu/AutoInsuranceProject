...
public class PaymentDetailController {
	...
	public ResponseEntity<Message> addNewPaymentDetail(@RequestBody PaymentDetail paymentDetail, @PathVariable long id) {
		try {
			...
			return new ResponseEntity<Message>(new Message("Upload Successfully!", null, null, null, Arrays.asList(returnedBill), null, null, null, ""), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Message> getPaymentDetailById(@PathVariable long id) {
		try {
			...
			if (optBill.isPresent()) {
				return new ResponseEntity<Message>(new Message("Successfully! Retrieve a Payment Detail by id = " + id, null, null, null, Arrays.asList(optBill.get()), null, null, null, ""), HttpStatus.OK);
			} else {
		...
		try {
			if (paymentDetailServices.checkExistedPaymentDetail(id)) {
				...
				return new ResponseEntity<Message>(
						new Message("Successfully! Updated a Payment Detail " + "with id = " + id, null, null, null, null, null, null, ""), HttpStatus.OK);
			} else {
				return new ResponseEntity<Message>(
